        ...
        <div className='mb-24'>
            ...
            <div className='flex md:flex-row flex-col justify-center'>
                <div className='md:w-[70%] w-full flex justify-center items-center'>
                    ...
                    <div className='absolute top-[475px] left-0 bg-white rounded-[27px] w-[250px] h-[220px] px-[24px] py-[20px] shadow-[0px_22.59px_36.14px_0px_#1e1e1e17]'>
                    ...
                    <div className='flex justify-center items-center absolute top-[785px] bg-white left-[18.19px] w-[245px] h-[88px] py-[1rem] pr-[2rem] pl-[1rem] rounded-[111.54px] shadow-[0px_15.21px_35.49px_0px_#00000017]'>
                        <PiRocketLaunchFill className='text-4xl text-[#2DA950]' />
                        <div><h3>10 DAYS</h3>
                            Staff Deployment</div>
                    </div>

                    <div className='absolute top-[140vh] left-[465px] bg-[#002E18] rounded-[28.36px] pt-[24px] pr-[30px] pb-[30px] pl-[36px] w-[280px]'>
